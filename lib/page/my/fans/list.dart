...
import 'package:trtc_demo/models/fans_list.dart';
...
class _FansListPageState extends State<FansListPage> {
  ...
  _fansList() async {
    ...
    var json = await Api.FansList({'page': _page, 'limit': 10});
    EasyLoading.dismiss();
    _init = true;
    var result = FansListModel.fromJson(json);
